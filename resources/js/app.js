...
import {
    ...
    faCaretUp, faUpload, faHome, faEllipsisV, faBars, faSignOutAlt, faChevronDown,
    faChevronUp, faTimes, faWallet, faChevronRight, faChevronLeft, faPlus, faExchangeAlt,
    faSlidersH, faRobot, faHistory, faSync, faCopy, faTachometerAlt, faUser, faCog,
...
library.add(faCheck, faCheckCircle, faInfoCircle, faExclamationTriangle, faExclamationCircle,
    ...
    faEye, faEyeSlash, faCaretDown, faCaretUp, faUpload, faHome, faBitcoin, faEllipsisV, faBars,
    faSignOutAlt, faChevronDown, faChevronUp, faTimes, faWallet, faChevronRight, faChevronLeft, faPlus,
    faExchangeAlt, faSlidersH, faRobot, faHistory, faSync, faCopy, faTachometerAlt, faUser, faCog, faEnvelope,
    faInfoCircle);
